...
$FORM_ID=19*$ASU_ID;
//var_dump($APPROVAL==$ADVISOR_TEAM);
//document.getElementById('tech_report').style.display = 'block';
/*if($row['Adivisory_Committee']==='0'){echo"<script>
...
<p><h3><b>Section C | Student Rating by Advisory Committee<i>(Please select one)</i></b></h3></p>
<div class="form-group">

      <label class="control-label col-md-1">Excellant</label>
      <div class="col-md-1">
	 ...
	 <label class="control-label col-md-3">Marginal<i>(in need of improvement;student does not meet minimum requirement)</i></label>
      <div class="col-md-1">
        <input type="radio" name="student_rating" id="student_rating" value='3'>
      </div>
      <label class="control-label col-md-3">Failure<i>(unsatisfactory;student should be required to withdraw)</i></label>
      <div class="col-md-1">
        <input type="radio" name="student_rating" id="student_rating" value="4">
      </div>
 </div>
<p><h3><b>Section D | Signatures</b></h3></p>
...
<div class="form-group">
    ...
    <table id="permanent_adv">
       <thead>
        ...
        <tr class="signature">
           <th><select name="advisor_member" id="advisor_member">
		<option>Graduate Co-ordinator</option>
		<option>Chair</option>
